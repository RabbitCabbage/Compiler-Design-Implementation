...
public interface MxParserVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link MxParser#mainFunctionDefinition}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitMainFunctionDefinition(MxParser.MainFunctionDefinitionContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by the {@code baseVariableDefinition}
	...
	/**
	 * Visit a parse tree produced by the {@code arrayVariableDefinition}
	 * labeled alternative in {@link MxParser#variableDefinition}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
