...
public interface MxParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link MxParser#mainFunctionDefinition}.
	 * @param ctx the parse tree
	 */
	void enterMainFunctionDefinition(MxParser.MainFunctionDefinitionContext ctx);
	/**
	 * Exit a parse tree produced by {@link MxParser#mainFunctionDefinition}.
	 * @param ctx the parse tree
	 */
	void exitMainFunctionDefinition(MxParser.MainFunctionDefinitionContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by the {@code baseVariableDefinition}
	 * labeled alternative in {@link MxParser#variableDefinition}.
	 * @param ctx the parse tree
	 */
	void enterBaseVariableDefinition(MxParser.BaseVariableDefinitionContext ctx);
	/**
	 * Exit a parse tree produced by the {@code baseVariableDefinition}
	 * labeled alternative in {@link MxParser#variableDefinition}.
	 * @param ctx the parse tree
	 */
	void exitBaseVariableDefinition(MxParser.BaseVariableDefinitionContext ctx);
	/**
	 * Enter a parse tree produced by the {@code arrayVariableDefinition}
	 * labeled alternative in {@link MxParser#variableDefinition}.
	 * @param ctx the parse tree
	 */
	void enterArrayVariableDefinition(MxParser.ArrayVariableDefinitionContext ctx);
	/**
	 * Exit a parse tree produced by the {@code arrayVariableDefinition}
	 * labeled alternative in {@link MxParser#variableDefinition}.
	 * @param ctx the parse tree
	 */
