...
forInitStatement:
    vardef = variableDefinition | init = expression Semicolon | Semicolon;//expressionStatement可以是空的


expression:
    basicExpression                                                                 # primaryExpression
        | lambdaExpression_                                                         # lambdaExpression
        ...
        | op = Minus expression                                                           # prefixExpression
...
lambdaExpression_:
    LeftBracket (And)? RightBracket (LeftParen parameter? (Comma parameter)* RightParen)? RightArrow suite LeftParen (expression (Comma expression)*)? RightParen;

newExpression_:
    New newType (LeftParen  expression? RightParen)?;
